export interface Session {
  ...
  speaker?: string
  role?: string
  type: 'logistics' | 'worship' | 'meal' | 'keynote' | 'prayer' | 'talk' | 'workshop' | 'discussion' | 'creatives' | 'kids'
}
...
export const schedule: DaySchedule[] = [
  {
    day: 'Day 1', label: 'Friday', date: 'July 10, 2026',
    sessions: [
  ...
  {
    day: 'Day 2', label: 'Saturday', date: 'July 11, 2026',
    sessions: [
  ...
  {
    day: 'Day 3', label: 'Sunday', date: 'July 12, 2026',
    sessions: [
